...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ReservationNotFoundException.class, PropertyNotFoundException.class})
    public ResponseEntity<Map<String, Object>> handleNotFound(RuntimeException ex) {
        return body(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler({NotReservationOwnerException.class, ReviewNotAllowedException.class})
    ...
    @ExceptionHandler(DateRangeUnavailableException.class)
    public ResponseEntity<Map<String, Object>> handleDateRangeUnavailable(DateRangeUnavailableException ex) {
        return body(HttpStatus.CONFLICT, ex.getMessage());
    }
